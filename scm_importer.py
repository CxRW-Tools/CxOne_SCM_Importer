...
def main():
    ...
    parser.add_argument('--repo-url', required=True, help='Git repository URL to import')
    parser.add_argument('--scm-token', required=True, help='SCM personal access token')
    parser.add_argument('--scm-org', required=True, help='The SCM organization in which the repos for this project are located')
    parser.add_argument('--project-name', required=True, help='Name of CxOne project to create')
